...
<div class="search-header search-area mr-4 mr-md-0 d-inline-block">								
	<div class="inner-search">
		<form role="search" <?php echo $twentytwenty_aria_label; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped above. ?> method="get" class="search-form position-relative py-3 px-4 p-md-0" action="<?php echo esc_url( home_url( '/' ) ); ?>">
			...
			<button class="btn btn-searchbox px-2 px-lg-3" type="submit" value="<?php echo esc_attr_x( 'Tìm kiếm thông tin', 'submit button', 'twentytwenty' ); ?>"><i data-click="" class="fas fa-search"></i></button>
		</form>
	</div>
</div>
